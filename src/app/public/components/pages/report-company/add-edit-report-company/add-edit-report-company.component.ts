...
@Component({
  selector: 'app-add-edit-report-company',
  templateUrl: './add-edit-report-company.component.html',
  styleUrls: ['./add-edit-report-company.component.scss']
})
export class AddEditReportCompanyComponent implements OnInit {
  @Input() reportId?: any;
  @Input() report?: any;
